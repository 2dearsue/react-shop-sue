  ...
  render() {
    return (
      <>
        ...
        <h3 className="display-5 text-center text-dark mt-4 text-uppercase">Book your course here:</h3>
          <div className="card-deck m-3">
            <div className="card text-white bg-dark m-3 d-inline-block">
              <div className="card-body">
                ...
                <a href="#!" class="card-link text-warning">Sign Up</a>
              </div>
            </div>
            <div className="card text-white bg-dark m-3 d-inline-block">
              <div className="card-body">
